...
(function($) {
    ...
    */
    ...
    $.formUtils = {
        ...
        */
        LANG : {
            errorTitle : 'ส่งฟอร์มล้มเหลว!',
            requiredFields : 'ไม่ควรเป็นค่าว่าง',
            badTime : 'คุณใส่เวลาไม่ถูกต้อง',
            badEmail : 'กรุณา กรอก e-mail ให้ถูกต้อง',
            badTelephone : 'คุณใส่หมายเลขโทรศัพท์ไม่ถูกต้อง',
            badSecurityAnswer : 'คำตอบไม่ถูกต้อง',
            badDate : 'คุณใส่วันที่ถไม่ถูกต้อง',
            lengthBadStart : 'มูลค่านำเข้าจะต้องเป็นระหว่าง ',
            lengthBadEnd : ' ตัวอักษร',
            lengthTooLongStart : 'กรุณา กรอกข้อมูลที่มีความยาว มากกว่า ',
            lengthTooShortStart : 'กรุณา กรอกข้อมูลที่มีความยาว อย่างน้อย ',
            notConfirmed : 'ค่าที่ป้อนไม่ได้รับการยืนยัน ',
            badDomain : ' domain ไม่ถูต้อง ',
            badUrl : 'URL ไม่่ถูกต้อง',
            badCustomVal : 'กรุณา กรอกข้อมูลให้ถูกต้อง',
            badInt : 'กรุณา กรอกข้อมูลเป็นตัวเลข',
